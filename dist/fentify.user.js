...
.gui-button-container {\r
    user-select: none;\r
}`;function re(r){let e=document.createElement("style");e.textContent=r,d.wrapper.appendChild(e)}var ie=new FontFace("Product Sans","url(https://fonts.gstatic.com/s/productsans/v19/pxiDypQkot1TnFhsFMOfGShVF9eO.woff2)",{style:"normal",weight:"400"});ie.load().then(r=>document.fonts.add(r));var se=new FontFace("Inter","url(https://fonts.gstatic.com/s/inter/v18/UcCO3FwrK3iLTeHuS_fvQtMwCp50KnMa.woff2)",{style:"normal",weight:"300"});se.load().then(r=>document.fonts.add(r));re(ee);j.init();g.init();document.addEventListener("keydown",r=>{m.emit("keydown",r.code)});setInterval(()=>{m.emit("render")},1e3/60);var ne=!0;ne&&(window.fentify={hooks:a,shadowWrapper:d,moduleManager:j,packets:g},window.fentify.gameUtils=v);})();
