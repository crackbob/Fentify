(()=>{var a={async init(){let r=app._vnode.component.appContext.provides,e=r[Object.getOwnPropertySymbols(r).find(i=>r[i]._s)];this._stores=e._s;let t=["app","gameState","friends","settings","sounds","itemsManager","roomManager","modals","user","chat","playerState","ads","alertSystem","shit","somePrefabThing","bub"],o=[...this._stores.values()];this.namedStores=Object.fromEntries(t.map((i,s)=>[i,o[s]]))},getStore(r){return this.namedStores[r]},get stores(){return{get:this.getStore.bind(this)}}};var m={listeners:{},activeKeys:new Set,on:function(r,e){this.listeners[r]||(this.listeners[r]=[]),this.listeners[r].push(e)},remove:function(r,e){this.listeners[r]&&(this.listeners[r]=this.listeners[r].filter(t=>t!==e))},emit:function(r,e){this.listeners[r]&&this.listeners[r].forEach(t=>t(e))},trackKey:function(r,e,t){r==="keydown"&&moduleManager.handleKeyPress(t),r==="keydown"&&!this.activeKeys.has(e)&&(this.activeKeys.add(e),this.emit("keyPress",{key:e,code:t})),r==="keyup"&&this.activeKeys.has(e)&&(this.activeKeys.delete(e),this.emit("keyRelease",{key:e,code:t}))}};var g={toServer:{TIME_STEP_INFO:5,PICKUP_DROP_ITEM:40,HIT:61},listeners:{},packetListener(r,e){Object.values(this.listeners).forEach(t=>{let o=t(r,e);o!=null&&(e=o)}),a.stores.get("gameState").gameWorld.server.msgsToSend.push(r,e)},init(){m.on("render",()=>{a?.stores?.get("gameState")?.gameWorld?.server?.sendData&&(a.stores.get("gameState").gameWorld.server.sendData=this.packetListener.bind(this))})}};var l=class{constructor(e,t,o,i){this.name=e,this.category=t,this.options=o,this.keybind=i,this.waitingForBind=!1,this.isEnabled=!1,this.modes={},this.toggle=this.toggle.bind(this)}registerMode(e,t){this.modes[e]=t}onEnable(){}onDisable(){}onRender(){}onSettingUpdate(){}onChunkAdded(){}onChunkRemoved(){}onGameEntered(){}onGameExited(){}onNoaTick(){}enable(){this.isEnabled=!0,m.emit("module.update",this),m.emit("module.toggle",{name:this.name,enabled:!0}),this.onEnable()}disable(){this.isEnabled=!1,m.emit("module.update",this),m.emit("module.toggle",{name:this.name,enabled:!1}),this.onDisable()}toggle(){this.isEnabled?this.disable():this.enable()}};var C=class extends l{constructor(){super("HitMultiplier","Combat",{Times:10})}onEnable(){a.stores.get("gameState").gameWorld?.player&&(g.listeners.HitMultiplier=function(e,t){if(e==g.toServer.HIT)for(let o=0;o<parseInt(this.options.Times);o++)setTimeout(()=>{a.stores.get("gameState").gameWorld.server.msgsToSend.push(g.toServer.HIT,t)},o*100)})}onDisable(){delete g.listeners.HitMultiplier}};var Z={normalizeVector(r){let e=r.x*r.x+r.y*r.y+r.z*r.z;if(e>0){let t=1/Math.sqrt(e);return[r.x*t,r.y*t,r.z*t]}return r},distanceBetween(r,e){let t=e.x-r.x,o=e.y-r.y,i=e.z-r.z;return t*t+o*o+i*i},distanceBetweenSqrt(r,e){return Math.sqrt(this.distanceBetween(r,e))}};var X={getClosestPlayer(){let r=a.stores.get("gameState").gameWorld,e=r.player.position,t=r.server.players,o=[];return t.forEach(function(i,s){let n=Z.distanceBetween(e,{x:i.position.x,y:i.position.y,z:i.position.z});i.id=s,o.push({player:i,distance:n})}),o.sort((i,s)=>i.distance-s.distance),o.map(i=>i.player)[0]}};var E=class extends l{constructor(){super("Killaura","Combat",{"Y Offset":1.62,Reach:10,Delay:100}),this.lastExecutionTime=null}onRender(){let e=Date.now();a.stores.get("gameState").gameWorld?.player&&e-this.lastExecutionTime>=this.options.Delay&&(this.lastExecutionTime=e,this.tryKill())}tryKill(){let e=this.options.Reach,t=this.options["Y Offset"],o=a.stores.get("gameState").gameWorld,i=X.getClosestPlayer(),s={x:o.player.position.x,y:o.player.position.y+t,z:o.player.position.z},n=i?.position;if(!n)return;let p={x:s.x-n.x,y:s.y-n.y,z:s.z-n.z},u=Math.sqrt(p.x*p.x+p.y*p.y+p.z*p.z);u!==0&&(p.x/=u,p.y/=u,p.z/=u),p.x=-p.x,p.y=-p.y,p.z=-p.z,Math.sqrt(Math.pow(s.x-n.x,2)+Math.pow(s.y-n.y,2)+Math.pow(s.z-n.z,2))<e&&(o.eventEmitter.emit(13),o.server.sendData(g.toServer.HIT,[s.x,s.y,s.z,p.x,p.y,p.z,o.time.localServerTimeMs,i.id]))}};var S=class extends l{constructor(){super("NoHitDelay","Combat")}onRender(){let e=a.stores.get("gameState")?.gameWorld?.systemsManager?.activeSystems.find(t=>t?.lastAttackTimeMs!==void 0);e&&(e.attackTimeDelayMs=0)}};var M=class extends l{constructor(){super("67Exploit","Misc")}onEnable(){a.stores.get("gameState").gameWorld.server.sendData(67,{type:1}),this.disable()}};var D=class extends l{constructor(){super("AdBypass","Misc")}onEnable(){this._reward=this._reward||a.stores.get("user").rewardCommercialVideoWrapper,a.stores.get("user").rewardCommercialVideoWrapper=()=>Promise.resolve(!0)}onDisable(){a.stores.get("user").rewardCommercialVideoWrapper=this._reward}};var L=class extends l{constructor(){super("FreeCoupons","Misc")}onEnable(){fetch("https://api.vectaria.io/v2/users/getAdCoupons",{credentials:"include"}).then(e=>{e.ok?a.stores.get("user").user.coupons+=10:alert("Reached Daily limit")}),this.disable()}};var W=class extends l{constructor(){super("InstantRespawn","Misc",null)}onRender(){if(!a.stores.get("gameState").gameWorld?.player)return;let e=a.stores.get("playerState");e.isDeath&&(e.respawn(),e.isDeath=!1)}};var z=class extends l{constructor(){super("NoFall","Misc",null)}onEnable(){a.stores.get("gameState").gameWorld?.player&&(g.listeners.NoFall=function(e,t){e==g.toServer.TIME_STEP_INFO&&t.v&&delete t.v})}onDisable(){delete g.listeners.NoFall}};var P=class extends l{constructor(){super("NoHunger","Misc",null)}onEnable(){a.stores.get("gameState").gameWorld?.player&&(g.listeners.NoHunger=function(e,t){e==g.toServer.TIME_STEP_INFO&&(t.m&&delete t.m,t.j&&delete t.j,t.b&&delete t.b)})}onDisable(){delete g.listeners.NoHunger}};var B=class extends l{constructor(){super("Airjump","Movement",null)}onRender(){a.stores.get("gameState").gameWorld?.player&&(a.stores.get("gameState").gameWorld.player.collision.isGrounded=!0)}};var I=class extends l{constructor(){super("AutoSprint","Movement",null)}onRender(){a.stores.get("gameState").gameWorld?.player&&(a.stores.get("gameState").gameWorld.player.velocity.speedBoosted=!0)}};var T=class extends l{constructor(){super("Fly","Movement",{"Vertical Speed":5})}onRender(){if(!a.stores.get("gameState").gameWorld?.player)return;let e=a.stores.get("gameState").gameWorld;e.player.velocity.gravity=0,e.player.inputs.jump?e.player.velocity.velVec3.y=this.options["Vertical Speed"]:e.player.inputs.crouch?e.player.velocity.velVec3.y=-this.options["Vertical Speed"]:e.player.velocity.velVec3.y=0}onDisable(){a.stores.get("gameState").gameWorld.player.velocity.gravity=23}};var N=class extends l{constructor(){super("HighJump","Movement",{"Jump Height":25})}onRender(){a._stores.get("gameState").gameWorld.player.velocity.jumpSpeed=parseFloat(this.options["Jump Height"])}onDisable(){a._stores.get("gameState").gameWorld.player.velocity.jumpSpeed=7.692307692307692}};var F=class extends l{constructor(){super("NoClip","Movement")}get playerPhysicsSystem(){return a.stores.get("gameState").gameWorld.systemsManager.activeSystems.find(e=>e?.playerPhysicsSystem).playerPhysicsSystem}onRender(){a.stores.get("gameState")?.gameWorld?.player&&(this._og=this._og||this.playerPhysicsSystem.resolveBlockCollision,this.playerPhysicsSystem.resolveBlockCollision==this._og&&(this.playerPhysicsSystem.resolveBlockCollision=()=>{}))}onDisable(){this.playerPhysicsSystem.resolveBlockCollision=this._og}};var H=class extends l{constructor(){super("Speed","Movement",{Speed:15})}onRender(){a.stores.get("gameState").gameWorld.player.velocity.moveSpeed=this.options.Speed,a.stores.get("gameState").gameWorld.player.velocity.fastMoveSpeed=this.options.Speed}onDisable(){a.stores.get("gameState").gameWorld.player.velocity.moveSpeed=4.5,a.stores.get("gameState").gameWorld.player.velocity.fastMoveSpeed=6.4}};var A=class extends l{constructor(){super("Velocity","Movement",null)}get serverPacketHandlers(){return a.stores.get("gameState").gameWorld.server.msgsListeners}get velocityPacket(){return Object.keys(this.serverPacketHandlers).find(e=>this.serverPacketHandlers[e].toString().includes("velocity"))}onEnable(){this.velocityHandler=this.velocityHandler||this.serverPacketHandlers[this.velocityPacket],this.serverPacketHandlers[this.velocityPacket]=()=>{}}onDisable(){this.serverPacketHandlers[this.velocityPacket]=this.velocityHandler}};var x={parseRGBString(r){let e=r.replaceAll("rgb","").replaceAll("a","").replaceAll("(","").replaceAll(")","").replaceAll(" ","").split(",");return{r:parseFloat(e?.[0]||1),g:parseFloat(e?.[1]||1),b:parseFloat(e?.[2]||1),a:parseFloat(e?.[3]||1)}},normalizeColor(r){return r?r.r<=1&&r.g<=1&&r.b<=1?r:{r:r.r/255,g:r.g/255,b:r.b/255}:{r:1,g:1,b:1}},hexToRGBA(r,e=1,t=1){let o=r.startsWith("#")?r.substring(1):r;o.length===3&&(o=o.split("").map(p=>p+p).join(""));let i=parseInt(o.substring(0,2),16)*t,s=parseInt(o.substring(2,4),16)*t,n=parseInt(o.substring(4,6),16)*t;return`rgba(${Math.round(i)}, ${Math.round(s)}, ${Math.round(n)}, ${e})`},hexToRgb(r){var e=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(r);return e?{r:parseInt(e[1],16),g:parseInt(e[2],16),b:parseInt(e[3],16)}:null}};var d={instance:null,get wrapper(){if(!this.instance){let r=document.createElement("iframe");document.body.appendChild(r);let e=r.contentWindow.Element.prototype.attachShadow;r.remove();let t=document.createElement("div");this.root=e.apply(t,[{mode:"closed"}]);let o=document.createElement("div");this.root.appendChild(o),this.instance=o,document.body.appendChild(t)}return this.instance}};var R=class extends l{constructor(){super("Arraylist","Visual",{Opacity:1,"Background Opacity":.1,"Darkness Multiplier":.3,"Accent Darkness":.5,Blur:1}),this.namesMap={},this.arraylistContainer=null,this.initialized=!1}getAccentColors(){let e=getComputedStyle(d.wrapper);return["--Fentify-accent-color-1","--Fentify-accent-color-2"].map(t=>e.getPropertyValue(t).trim())}update(e,t){if(t){if(!this.namesMap[e]){let i=document.createElement("div"),s=this.getAccentColors(),n=parseFloat(this.options["Background Opacity"]),p=parseFloat(this.options["Darkness Multiplier"]),u=parseFloat(this.options["Accent Darkness"]),h=parseFloat(this.options.Blur);i.style.background=`linear-gradient(to right, ${x.hexToRGBA(s[0],n,u)}, ${x.hexToRGBA(s[1],n+.2,u+.2)})`,i.style.backdropFilter=`blur(${h}px) brightness(${p})`,i.style.color="white",i.style.padding="2px 10px",i.style.display="flex",i.style.alignItems="center",i.style.boxSizing="border-box",i.style.margin="0",i.style.lineHeight="1",i.style.gap="0",i.style.fontFamily="'Product Sans', sans-serif",i.style.boxShadow="rgb(0, 0, 0, 0.05) -5px 1px",i.style.transition="opacity 0.2s ease-in-out, max-height 0.2s ease-in-out",i.style.overflow="hidden",i.style.maxHeight="0",i.style.opacity=parseFloat(this.options.Opacity);let f=document.createElement("span");f.style.fontWeight="800",f.style.fontSize="16px",f.style.backgroundImage="var(--Fentify-accent-color)",f.style.color="transparent",f.style.backgroundClip="text",f.style.webkitBackgroundClip="text",f.innerHTML=e,i.appendChild(f),this.arraylistContainer.appendChild(i),setTimeout(()=>{i.style.maxHeight="50px",i.style.opacity="1"},1),this.namesMap[e]=i}}else if(this.namesMap[e]){let i=this.namesMap[e];i.style.maxHeight="0",i.style.opacity="0",setTimeout(()=>{this.arraylistContainer.contains(i)&&this.arraylistContainer.removeChild(i),delete this.namesMap[e]},200)}let o=Object.values(this.namesMap).sort((i,s)=>this.measureElementWidth(s)-this.measureElementWidth(i));this.arraylistContainer.innerHTML="",o.forEach(i=>this.arraylistContainer.appendChild(i))}onEnable(){this.initialized?this.arraylistContainer.style.opacity="1":(this.arraylistContainer=document.createElement("div"),this.arraylistContainer.style.flexDirection="column",this.arraylistContainer.style.display="flex",this.arraylistContainer.style.gap="0",this.arraylistContainer.style.lineHeight="0",this.arraylistContainer.style.position="absolute",this.arraylistContainer.style.zIndex="1000",this.arraylistContainer.style.right="5px",this.arraylistContainer.style.top="5px",this.arraylistContainer.style.alignItems="flex-end",this.arraylistContainer.style.pointerEvents="none",this.arraylistContainer.style.textTransform="lowercase",this.arraylistContainer.style.border="2px solid transparent",this.arraylistContainer.style.borderImage="var(--Fentify-accent-color)",this.arraylistContainer.style.borderImageSlice="1",this.arraylistContainer.style.borderBottom="0",this.arraylistContainer.style.borderLeft="0",d.wrapper.appendChild(this.arraylistContainer),m.on("module.update",e=>{this.update(e.name,e.isEnabled)}),this.initialized=!0)}onSettingUpdate(e){if(e=="ClickGUI"||e=="Arraylist"){let t=this.getAccentColors(),o=parseFloat(this.options["Background Opacity"]),i=parseFloat(this.options["Darkness Multiplier"]),s=parseFloat(this.options["Accent Darkness"]),n=parseFloat(this.options.Blur);Object.values(this.namesMap).forEach(p=>{p.style.background=`linear-gradient(to right, ${x.hexToRGBA(t[0],o,s)}, ${x.hexToRGBA(t[1],o+.2,s+.2)})`,p.style.backdropFilter=`blur(${n}px) brightness(${i})`,p.style.opacity=parseFloat(this.options.Opacity)})}}measureElementWidth(e){return e.getBoundingClientRect().width}onDisable(){this.arraylistContainer.style.opacity="0"}};var O=class{constructor(e,t){this.module=e,this.container=t,this.components=[],this.initialized=!1,this.isOpen=!1,this.activeDropdown=null,this.currentOptionsList=null,this.activeDropdownListeners=null}initialize(){if(this.initialized||!this.module?.options)return;this.settingsWrapper=document.createElement("div"),this.settingsWrapper.className="module-settings-wrapper",this.container.appendChild(this.settingsWrapper),this.settingsContainer=document.createElement("div"),this.settingsContainer.className="module-settings scrollable",this.settingsWrapper.appendChild(this.settingsContainer),this.container.style.position="relative";let e=Object.keys(this.module.options),t=this.groupSettings(e);this.createSettings(t),this.initialized=!0}groupSettings(e){return e.reduce((t,o)=>{let i=this.module.options[o],s=typeof i;return o.toLowerCase().includes("color")?t.color.push(o):this.module.modes&&this.module.modes[o]?t.mode.push(o):s==="boolean"||i==="true"||i==="false"?t.boolean.push(o):t.other.push(o),t},{boolean:[],mode:[],other:[],color:[]})}createSettings(e){[...e.boolean,...e.mode,...e.other,...e.color].forEach(t=>{let o=this.module.options[t],i=typeof o;t.toLowerCase().includes("color")?this.addColorPicker(t):this.module.modes&&this.module.modes[t]?this.addModeSelector(t):i==="boolean"||o==="true"||o==="false"?this.addCheckbox(t):i==="string"?this.addStringInput(t):this.addNumberInput(t)})}toggle(){this.isOpen=!this.isOpen,this.isOpen&&this.settingsWrapper?.classList?(this.settingsWrapper.classList.add("module-settings-open"),this.checkPositionWithinViewport()):this.settingsWrapper?.classList&&(this.settingsWrapper.classList.remove("module-settings-open"),this.closeAllDropdowns())}checkPositionWithinViewport(){if(!this.settingsWrapper)return;let e=this.settingsWrapper.getBoundingClientRect(),t=window.innerHeight;if(e.bottom>t){let o=e.bottom-t;this.settingsWrapper.style.maxHeight=`${e.height-o-10}px`}}cleanup(){this.closeAllDropdowns(),this.isOpen=!1,this.settingsWrapper&&this.settingsWrapper.classList.remove("module-settings-open")}closeAllDropdowns(){document.querySelectorAll(".gui-dropdown-options").forEach(t=>{d.wrapper.contains(t)&&d.wrapper.removeChild(t)}),this.currentOptionsList&&(this.currentOptionsList=null),this.activeDropdown&&(this.activeDropdown.classList.remove("open"),this.activeDropdown.optionsListElement&&(this.activeDropdown.optionsListElement=null),this.activeDropdown=null),this.activeDropdownListeners&&(document.removeEventListener("click",this.activeDropdownListeners.outsideClickHandler),window.removeEventListener("scroll",this.activeDropdownListeners.hideDropdown,!0),window.removeEventListener("resize",this.activeDropdownListeners.hideDropdown,!0),this.activeDropdownListeners=null)}addNumberInput(e){let t=document.createElement("div");t.className="gui-setting-container setting-number";let o=document.createElement("div");o.className="gui-setting-label",o.textContent=e;let i=document.createElement("div");i.className="number-input-container";let s=document.createElement("input");s.type="text",s.className="gui-text-input number-input",s.value=this.module.options[e],s.addEventListener("input",()=>{let n=s.value.trim();!isNaN(n)&&n!==""&&(this.module.options[e]=n,m.emit("setting.update",{moduleName:this.module.name,setting:e,value:n}))}),s.addEventListener("blur",()=>{(isNaN(s.value)||s.value.trim()==="")&&(s.value=this.module.options[e])}),s.addEventListener("keydown",n=>{n.key==="Enter"&&s.blur()}),i.appendChild(s),t.appendChild(o),t.appendChild(i),this.settingsContainer.appendChild(t),this.components.push(t)}addStringInput(e){let t=document.createElement("div");t.className="gui-setting-container setting-string";let o=document.createElement("div");o.className="gui-setting-label",o.textContent=e;let i=document.createElement("div");i.className="string-input-container";let s=document.createElement("input");s.type="text",s.className="gui-text-input string-input",s.value=this.module.options[e],s.addEventListener("input",()=>{this.module.options[e]=s.value,m.emit("setting.update",{moduleName:this.module.name,setting:e,value:s.value})}),s.addEventListener("keydown",n=>{n.key==="Enter"&&s.blur()}),i.appendChild(s),t.appendChild(o),t.appendChild(i),this.settingsContainer.appendChild(t),this.components.push(t)}addCheckbox(e){let t=document.createElement("div");t.className="gui-setting-container setting-boolean";let o=document.createElement("div");o.className="gui-setting-label",o.textContent=e;let i=document.createElement("div");i.className="checkbox-container";let s=document.createElement("div");s.className="gui-checkbox",(this.module.options[e]===!0||this.module.options[e]==="true")&&s.classList.add("enabled"),t.addEventListener("click",()=>{let n=!(this.module.options[e]===!0||this.module.options[e]==="true");this.module.options[e]=n.toString(),n?s.classList.add("enabled"):s.classList.remove("enabled"),m.emit("setting.update",{moduleName:this.module.name,setting:e,value:n.toString()})}),i.appendChild(s),t.appendChild(o),t.appendChild(i),this.settingsContainer.appendChild(t),this.components.push(t)}addColorPicker(e){let t=document.createElement("div");t.className="gui-setting-container setting-color";let o=document.createElement("div");o.className="gui-setting-label",o.textContent=e;let i=document.createElement("div");i.className="gui-color-row";let s=document.createElement("div");s.className="color-picker-container";let n=document.createElement("div");n.className="gui-color-picker",n.style.background=this.module.options[e];let p=document.createElement("input");p.type="color",p.className="gui-color-input",p.value=this.rgbToHex(this.module.options[e]);let u=document.createElement("input");u.type="text",u.className="gui-text-input color-text-input",u.value=this.formatColor(this.module.options[e]),p.addEventListener("input",h=>{let f=h.target.value;n.style.background=f,u.value=f,this.module.options[e]=f,m.emit("setting.update",{moduleName:this.module.name,setting:e,value:f})}),u.addEventListener("blur",()=>{try{let h=u.value;n.style.background=h,this.module.options[e]=h,m.emit("setting.update",{moduleName:this.module.name,setting:e,value:h})}catch{u.value=this.formatColor(this.module.options[e])}}),u.addEventListener("keydown",h=>{h.key==="Enter"&&u.blur()}),n.appendChild(p),s.appendChild(n),i.appendChild(s),i.appendChild(u),t.appendChild(o),t.appendChild(i),this.settingsContainer.appendChild(t),this.components.push(t)}addModeSelector(e){let t=document.createElement("div");t.className="gui-setting-container setting-mode";let o=document.createElement("div");o.className="gui-setting-label",o.textContent=e;let i=this.module.modes?.[e]||[],s=this.module.options[e],n=document.createElement("div");n.className="gui-dropdown mode-dropdown";let p=document.createElement("div");p.className="gui-dropdown-selected",p.textContent=s;let u=document.createElement("div");u.className="gui-dropdown-arrow",n.appendChild(p),n.appendChild(u);let h=()=>{if(!n.classList.contains("open"))return;let c=n.optionsListElement;c&&d.wrapper.contains(c)&&d.wrapper.removeChild(c),this.currentOptionsList===c&&(this.currentOptionsList=null),this.activeDropdown===n&&(this.activeDropdown=null),n.classList.remove("open"),n.optionsListElement=null,this.activeDropdownListeners&&this.activeDropdownListeners.dropdown===n&&(document.removeEventListener("click",this.activeDropdownListeners.outsideClickHandler),window.removeEventListener("scroll",this.activeDropdownListeners.hideDropdown,!0),window.removeEventListener("resize",this.activeDropdownListeners.hideDropdown,!0),this.activeDropdownListeners=null)},f=c=>{let b=n.optionsListElement;!n.contains(c.target)&&(!b||!b.contains(c.target))&&h()},w=()=>{h()},J=()=>{this.closeAllDropdowns();let c=document.createElement("div");c.className="gui-dropdown-options mode-options",i.forEach(y=>{let k=document.createElement("div");k.className="gui-dropdown-option mode-option",y===this.module.options[e]&&k.classList.add("selected"),k.textContent=y,k.addEventListener("click",ee=>{ee.stopPropagation(),p.textContent=y,this.module.options[e]=y,m.emit("setting.update",{moduleName:this.module.name,setting:e,value:y}),h()}),c.appendChild(k)}),d.wrapper.appendChild(c),n.optionsListElement=c;let b=n.getBoundingClientRect();c.style.width=b.width+"px",c.style.position="fixed";let q=window.innerHeight-b.bottom,v=Math.min(i.length*30,150);q<v&&b.top>v?(c.style.bottom=window.innerHeight-b.top+"px",c.style.top="auto",c.classList.add("dropdown-up")):(c.style.top=b.bottom+"px",c.style.bottom="auto",c.classList.remove("dropdown-up")),c.style.left=b.left+"px",c.style.zIndex="1001",n.classList.add("open"),this.activeDropdown=n,this.currentOptionsList=c,this.activeDropdownListeners={dropdown:n,outsideClickHandler:f,hideDropdown:w},setTimeout(()=>{this.activeDropdown===n&&this.activeDropdownListeners&&this.activeDropdownListeners.dropdown===n&&(document.addEventListener("click",f),window.addEventListener("scroll",w,!0),window.addEventListener("resize",w,!0))},0)};n.addEventListener("click",c=>{c.stopPropagation(),n.classList.contains("open")?h():J()}),t.appendChild(o),t.appendChild(n),this.settingsContainer.appendChild(t),this.components.push(t)}positionDropdown(e,t){let o=e.getBoundingClientRect(),i=this.settingsWrapper.getBoundingClientRect();t.style.position="absolute",t.style.width=o.width+"px",t.style.left="0";let s=window.innerHeight-o.bottom,n=t.clientHeight||150;if(s<n&&o.top>n?(t.style.bottom=o.height+"px",t.style.top="auto",t.classList.add("dropdown-up")):(t.style.top=o.height+"px",t.style.bottom="auto",t.classList.remove("dropdown-up")),t.getBoundingClientRect().right>i.right){let p=t.getBoundingClientRect().right-i.right;t.style.left=-p+"px"}}rgbToHex(e){if(!e)return"#000000";if(e.startsWith("#"))return e;let t=e.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*[\d.]+)?\)/i);if(!t)return"#000000";let o=parseInt(t[1]),i=parseInt(t[2]),s=parseInt(t[3]);return"#"+((1<<24)+(o<<16)+(i<<8)+s).toString(16).slice(1)}formatColor(e){return e?e.startsWith("rgb")?this.rgbToHex(e):e:"#000000"}};var _=class{constructor(e,t={top:"200px",left:"200px"}){this.panel=document.createElement("div"),this.panel.className="gui-panel",this.panel.style.top=t.top,this.panel.style.left=t.left,this.header=document.createElement("div"),this.header.className="gui-header",this.header.textContent=e,this.panel.appendChild(this.header),d.wrapper.appendChild(this.panel),this.buttons=[],this.setupDragHandling()}setupDragHandling(){let e=!1,t={x:0,y:0};this.header.addEventListener("mousedown",o=>{e=!0,t.x=o.clientX-this.panel.offsetLeft,t.y=o.clientY-this.panel.offsetTop}),document.addEventListener("mousemove",o=>{e&&(this.panel.style.left=o.clientX-t.x+"px",this.panel.style.top=o.clientY-t.y+"px")}),document.addEventListener("mouseup",()=>e=!1)}addButton(e){let t=document.createElement("div");t.className="gui-button-container";let o=document.createElement("div");o.className=`gui-button ${e.isEnabled?"enabled":""}`,o.textContent=e.name;let i=new O(e,t);return o.addEventListener("mousedown",s=>{s.button===0&&(e.toggle(),o.classList.toggle("enabled",e.isEnabled)),s.button===1&&(o.textContent="waiting for bind..",e.waitingForBind=!0)}),o.addEventListener("contextmenu",s=>{s.preventDefault(),i.initialize(),i.toggle()}),o.setAttribute("tabindex",-1),o.addEventListener("keydown",s=>{o.textContent=e.name,e.waitingForBind&&(s.preventDefault(),s.stopPropagation(),s.stopImmediatePropagation(),s.key==="Escape"?e.keybind=null:e.keybind=String(s.code),e.waitingForBind=!1)}),t.appendChild(o),this.panel.appendChild(t),this.buttons.push(o),o}show(){this.panel.style.display="block"}hide(){this.panel.style.display="none"}};var j=class extends l{constructor(){super("ClickGUI","Visual",{"Accent Color 1":"#40beffff","Accent Color 2":"#81e1ffff","Button Color":"rgb(40, 40, 40, 0.9)","Hover Color":"rgb(50, 50, 50, 0.9)","Header Color":"rgb(0, 0, 0, 0.85)","Panel Color":"rgb(18 18 18)","Text Color":"#ffffff","Glow Alpha":"0.8","Enable Animations":!0},"ShiftRight"),this.GUILoaded=!1,this.panels=[],this.blurredBackground=null,this.updateColors()}updateAnimations(){this.options["Enable Animations"]?d.wrapper.classList.add("with-animations"):d.wrapper.classList.remove("with-animations")}updateColors(){let e=`linear-gradient(90deg, ${this.options["Accent Color 1"]} 0%, ${this.options["Accent Color 2"]} 100%)`;d.wrapper.style.setProperty("--Fentify-accent-color",e),d.wrapper.style.setProperty("--Fentify-accent-color",e),d.wrapper.style.setProperty("--Fentify-accent-color-1",this.options["Accent Color 1"]),d.wrapper.style.setProperty("--Fentify-accent-color-2",this.options["Accent Color 2"]),d.wrapper.style.setProperty("--Fentify-button-color",this.options["Button Color"]),d.wrapper.style.setProperty("--button-color",this.options["Button Color"]),d.wrapper.style.setProperty("--hover-color",this.options["Hover Color"]),d.wrapper.style.setProperty("--header-bg",this.options["Header Color"]),d.wrapper.style.setProperty("--panel-bg",this.options["Panel Color"]),d.wrapper.style.setProperty("--text-color",this.options["Text Color"]),d.wrapper.style.setProperty("--glow-color",x.hexToRGBA(this.options["Accent Color 1"],parseFloat(this.options["Glow Alpha"]),1.2))}onEnable(){document.pointerLockElement&&document.exitPointerLock(),this.GUILoaded?(this.showGUI(),this.updateAnimations()):(this.setupBackground(),this.createPanels(),this.setupEventListeners(),this.GUILoaded=!0,this.updateAnimations())}setupBackground(){this.blurredBackground=document.createElement("div"),this.blurredBackground.className="gui-background",d.wrapper.appendChild(this.blurredBackground)}createPanels(){let e=[{title:"Combat",position:{top:"100px",left:"100px"}},{title:"Movement",position:{top:"100px",left:"338px"}},{title:"Visual",position:{top:"100px",left:"576px"}},{title:"World",position:{top:"100px",left:"814px"}},{title:"Misc",position:{top:"100px",left:"1052px"}}];this.panels.forEach(o=>{o.panel&&o.panel.parentNode&&o.panel.parentNode.removeChild(o.panel)}),this.panels=[],e.forEach(o=>{let i=new _(o.title,o.position);this.panels.push(i)});let t={};Object.values(G.modules).forEach(o=>{t[o.category]||(t[o.category]=[]),t[o.category].push(o)}),Object.entries(t).forEach(([o,i])=>{let s=this.panels.find(p=>p.header.textContent===o);if(!s)return;let n=document.createElement("span");n.style.visibility="hidden",n.style.position="absolute",n.style.font="'Product Sans', sans-serif",d.wrapper.appendChild(n),i.sort((p,u)=>{n.textContent=p.name;let h=n.getBoundingClientRect().width;return n.textContent=u.name,n.getBoundingClientRect().width-h}),n.remove(),i.forEach(p=>s.addButton(p))})}setupEventListeners(){m.on("module.update",e=>{let t=this.panels.find(i=>i.header.textContent===e.category);if(!t)return;let o=t.buttons.find(i=>i.textContent===e.name);o&&o.classList.toggle("enabled",e.isEnabled)})}showGUI(){this.panels.forEach(e=>e.show()),this.blurredBackground.style.display="block"}returnToGame(){}onDisable(){this.panels.forEach(e=>e.hide()),this.blurredBackground.style.display="none",this.returnToGame()}onSettingUpdate(){this.updateColors(),this.updateAnimations()}};var U=class extends l{constructor(){super("Watermark","Visual",{Text:"Fentify"},""),this.watermarkElement=null,this.mainText=null}onSettingUpdate(){this.mainText&&(this.mainText.textContent=this.options.Text)}onEnable(){if(!this.watermarkElement){let e=document.createElement("div");e.style.position="absolute",e.style.top="0",e.style.left="0",e.style.padding="0.5em",e.style.userSelect="none",e.style.display="flex",e.style.zIndex="999999",e.style.fontFamily="'Product Sans', sans-serif",e.style.fontSize="24px",e.style.backgroundClip="text",e.style.webkitFontSmoothing="antialiased",e.style.webkitTextFillColor="transparent",e.style.textShadow="var(--Fentify-accent-color) 0px 0px 10px",e.style.background="var(--Fentify-accent-color)",e.style.backgroundClip="text",this.mainText=document.createElement("span"),this.mainText.textContent="Fentify";let t=document.createElement("span");t.textContent="v2",t.style.fontSize="14px",t.style.paddingBottom="15px",t.style.marginLeft="4px",t.style.alignSelf="flex-end",e.appendChild(this.mainText),e.appendChild(t),d.wrapper.appendChild(e),this.watermarkElement=e}this.watermarkElement.style.display="flex"}onDisable(){this.watermarkElement.style.display="none"}};var Y=class extends l{constructor(){super("Instabreak","World",{"Allow Bedrock":!1})}onRender(){let e=a.stores.get("gameState").gameWorld;if(!e||!e?.chunkManager)return;let t=e.player?.destroyingBlockXYZ;if(!t)return;let o=e.chunkManager.getBlock(...t);if(o==null)return;let i=e.allItems?.[o];i&&(!this.options["Allow Bedrock"]&&i.name==="Bedrock"||e.chunkManager.placeBlockWithMsgSending(...t,0))}};var V=class extends l{constructor(){super("PickupReach","World",{Reach:5,Delay:1e3}),this.lastExecutionTime=0}onRender(){let e=Date.now(),t=parseFloat(this.options.Delay);if(e-this.lastExecutionTime<t)return;let o=a.stores.get("gameState")?.gameWorld;o?.player&&(this.tryPickup(o),this.lastExecutionTime=e)}get pickupSystem(){return a.stores.get("gameState")?.gameWorld?.systemsManager?.activeSystems.find(t=>t?.allDropItems)}tryPickup(e){let t=parseFloat(this.options.Reach),o=t*t,i=e.player.position,s=i.x,n=i.y,p=i.z,u=this.pickupSystem?.allDropItems;if(!u)return;let h=null,f=null,w=1/0;for(let[J,c]of Object.entries(u)){if(!c?.pos)continue;let b=c.pos.x-s,q=c.pos.y-n,v=c.pos.z-p,y=b*b+q*q+v*v;y>o||y>=w||(w=y,h=c,f=J)}!h||f==null||h.pickupRequested||(e.server.sendData(g.toServer.TIME_STEP_INFO,{p:[...h.pos]}),e.server.sendData(g.toServer.PICKUP_DROP_ITEM,f),e.server.sendData(g.toServer.TIME_STEP_INFO,{p:[...i]}),h.pickupRequested=!0)}};var $=class extends l{constructor(){super("Scaffold","World",null)}onRender(){let e=a.stores.get("gameState").gameWorld,t=Object.values(e.player.position).splice(0,3).map(Math.floor);t[1]--;let o=e.player.currentHandItemId,i=e.chunkManager.getBlock(...t),s=e.allItems[i]?.replaceable||!1;(i==0||s)&&o&&e.chunkManager.placeBlockWithMsgSending(...t,o)}};var K=class extends l{constructor(){super("Timer","World",{Multiplier:1.2})}onRender(){let e=a.stores.get("gameState").gameWorld.time;e.elapsedTimeMs+=20*this.options.Multiplier}};var G={modules:{},addModules:function(...r){for(let e of r){let t=new e;this.modules[t.name]=t}},addModule:function(r){this.modules[r.name]=r},handleKeyPress:function(r){for(let e in this.modules){let t=this.modules[e];t.waitingForBind?(t.keybind=r,t.waitingForBind=!1):r&&t.keybind==r&&t.toggle()}},init(){this.addModules(U,j,R,T,B,H,A,I,N,F,Y,K,$,V,E,S,C,M,D,W,z,P,L),m.on("render",()=>{for(let r in this.modules)this.modules[r].isEnabled&&this.modules[r].onRender()}),m.on("keydown",this.handleKeyPress.bind(this)),m.on("setting.update",r=>{for(let e in this.modules)(this.modules[e].isEnabled||r.moduleName===e)&&this.modules[e].onSettingUpdate(r.moduleName,r.setting,r.value)}),this.modules.Arraylist.enable(),this.modules.Watermark.enable()}};var Q=`:host {\r
...
.gui-button-container {\r
    user-select: none;\r
}`;function oe(r){let e=document.createElement("style");e.textContent=r,d.wrapper.appendChild(e)}oe(Q);a.init();G.init();g.init();document.addEventListener("keydown",r=>{m.emit("keydown",r.code)});setInterval(()=>{m.emit("render")},1e3/60);var re=!0;re&&(window.fentify={hooks:a,shadowWrapper:d,moduleManager:G,packets:g},window.fentify.gameUtils=X);})();
